...
public class Application {
    ...
    private static void selectBuilderSubMenu() {
        ...
        do{
            System.out.println("========== SelectBuilder 서브메뉴 ========");
            System.out.println("1.SelectBuilder 기본 구문 사용하기");
            System.out.println("2. SqlBuilder를 이용한 동적 SQL 사용하기");
            ...
            switch (no) {
                ...
                case 2 : selectBuilderService.testDynamicStatement(inputSearchCriteris()); break;
                case 9 : return;
            }
        } while (true);
    }

    private static SearchCriteria inputSearchCriteris() {
    ...
    private static void sqlBuilderSubMenu() {
        ...
        do{
            System.out.println("========== SqlBuilder 서브메뉴 ========");
